...
<div class="container-fluid">
    <div class="row fh5co-post-entry single-entry">
        <article class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
            ...
            <h2 class="fh5co-article-title animate-box"><input type="text" id="note_title" disabled="disabled" placeholder="Başlık"> </h2>
            <span class="fh5co-meta fh5co-date animate-box">6 Mart 2016</span>

            <div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-left content-article">
                <div class="row">
                    <div class="col-lg-8 cp-r animate-box">
                        <textarea class="form form-control" id="note_content" style=" cursor:default;width:100%;height: 100%;" placeholder="Note Context" disabled="disabled"></textarea>
                    ...
                    <div class="col-lg-4 animate-box">
                        <div class="fh5co-highlight right">
                            <button class="btn btn-info" style="width: 100%;" onclick="update()" id="updateBtn">Güncelle</button>
                                 <br/><br/>
                            <button class="btn btn-danger" style="width: 100%;" onclick="deleteNote()" id="deleteBtn">Sil</button>
                        </div>
